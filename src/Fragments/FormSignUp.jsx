...
import { Link } from "react-router-dom"; // Digunakan untuk berpindah halaman tanpa reload
    ...
    <>
      ...
      <div className="mt-16">
        <form action="">
          ...
          {/* Teks Terms of Service sesuai gambar */}
      ...
      {/* link start: Mengarah balik ke halaman login */}
